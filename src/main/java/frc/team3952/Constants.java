...
public final class Constants {
    ...
    public static class FieldConstants {
         ...
         * <p>
         * The original values are for the blue alliance (since the origin is on the blue alliance's side), so we use {@link frc.team3952.MathUtil#mirrorValueOnFieldForOppositeSide(double) MathUtil.mirrorValueOnFieldXAxis(double)} to mirror the values for the red alliance.
         * <p>
