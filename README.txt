...
This is the readme for armvisualiser, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Armvisualiser) > Ok.
...
- To run the project find Armvisualiser.java (which will be in under src/main/java/frc/team) and right click > Run 'Armvisualiser'
